...
"for s21_grep_func.c s21_grep_func.h Makefile VAR"
"for s21_grep_main.c VAR"
"-e for -e ^int s21_grep_func.c s21_grep_func.h Makefile VAR"
"-e for -e ^int s21_grep_func.c VAR"
"-e regex -e ^print s21_grep_main.c VAR -f test_ptrn_grep.txt"
"-e while -e void s21_grep_main.c Makefile VAR -f test_ptrn_grep.txt"
)
